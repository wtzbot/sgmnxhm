...
if (Config.WORKTYPE == 'public') {
 ...
 Trex.addrex({ pattern: 'ff9 ?(.*)', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.jpg, caption:  ' ❰ 🇱🇰🔰✥▬ALPHA▬✥🔰🇱🇰 ❱   ' ,quoted: message.data })
 ...
 Trex.addrex({ pattern: 'ff9 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.jpg, caption:  ' ❰ 🇱🇰🔰✥▬ALPHA▬✥🔰🇱🇰 ❱   ' })
