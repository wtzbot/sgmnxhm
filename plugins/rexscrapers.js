...
Trex.addrex({pattern: 'play ?(.*)', fromMe: true, desc: Lang.PLAY_DESC}, (async (message, match) => { 
        ...
        var reply = await message.client.sendMessage(message.jid,`🔰 ➢ සින්දුව ඩව්න්ලෝඩ් වෙන ගමන් පොඩ්ඩක් ඉන්න 🤭...`,MessageType.text);
    ...
    Trex.addrex({pattern: 'fsong ?(.*)', fromMe: true, desc: Lang.SONG_DESC}, (async (message, match) => { 
        ...
        ffmpeg(stream)
            ...
            .on('end', async () => {
                ...
                reply = await message.client.sendMessage(message.jid,`🔰 ➢ ඔයා ඉල්ලපු සින්දුව මන් අප්ලෝඩ් කරන ගමන් දැන් එයි 🤤...`,MessageType.text);
...
Trex.addrex({pattern: 'video ?(.*)', fromMe: true, desc: 'hu'}, (async (message, match) => { 
    ...
    Trex.addrex({ pattern: 'insta ?(.*)', fromMe: true,  deleteCommand: false, desc: Lang.IG_DESC}, (async (message, match) => {
      ...
      if (msg === '200') {
        ...
        await message.sendMessage(Buffer.from(profileBuffer.data), MessageType.video, {caption: "❰ 🇱🇰🔰✥▬ALPHA▬✥🔰🇱🇰 ❱"}) 
        }
          })
          .catch(
    ...
    Trex.addrex({pattern: 'play ?(.*)', fromMe: false, desc: Lang.PLAY_DESC}, (async (message, match) => { 
        ...
        var reply = await message.client.sendMessage(message.jid,`🔰 ➢ සින්දුව ඩව්න්ලෝඩ් වෙන ගමන් පොඩ්ඩක් ඉන්න 🤭....`,MessageType.text, {quoted: message.data});
    ...
    Trex.addrex({ pattern: 'fsong ?(.*)', fromMe: false, desc: Lang.SONG_DESC}, (async (message, match) => {
        ...
        ffmpeg(stream)
            ...
            .on('end', async () => {
                ...
                reply = await message.client.sendMessage(message.jid,`🔰 ➢ ඔයා ඉල්ලපු සින්දුව මන් අප්ලෝඩ් කරන ගමන් දැන් එයි 🤤...`,MessageType.text, {quoted: message.data});
                await message.client.sendMessage(message.jid,Buffer.from(writer.arrayBuffer), MessageType.document, {filename: title + '.mp3', mimetype: 'audio/mpeg'});
            });
    }));
    ...
    Trex.addrex({ pattern: 'insta ?(.*)', fromMe: false, desc: Lang.IG_DESC}, (async (message, match) => {
      ...
      if (msg === '200') {
        ...
        await message.sendMessage(Buffer.from(profileBuffer.data), MessageType.video, {quoted: message.data}, {caption: "❰ 🇱🇰🔰✥▬ALPHA▬✥🔰🇱🇰 ❱"}) 
        }
          })
          .catch(
