    ...
    Trex.addrex({pattern: 'ffmpeg ?(.*)', fromMe: true,  deleteCommand: false,  desc: Lang.FF_DESC}, (async (message, match) => {
        ...
        if (message.reply_message.video) {
            ...
            ffmpeg(location)
                ...
                .save('Trex.mp4')
                .on('end', async () => {
                    await message.sendMessage(fs.readFileSync('Trex.mp4'), MessageType.video, {mimetype: Mimetype.mpeg, caption: '❰ 🇱🇰🔰✥▬ALPHA▬✥🔰🇱🇰 ❱'});
                });
            ...
            ffmpeg(location)
                ...
                .save('Trex.jpg')
                .on('end', async () => {
                    await message.sendMessage(fs.readFileSync('Trex.jpg'), MessageType.image, {mimetype: Mimetype.jpg, caption: '❰ 🇱🇰🔰✥▬ALPHA▬✥🔰🇱🇰 ❱'});
                });
            return await message.client.deleteMessage(message.jid, {id: downloading.key.id, remoteJid: message.jid, fromMe: true})
        }
        else {
