...
if (Config.WORKTYPE == 'private') {
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: '*❰ 🇱🇰🔰✥▬ALPHA▬✥🔰🇱🇰 ❱*'})
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: '*❰ 🇱🇰🔰✥▬ALPHA▬✥🔰🇱🇰 ❱*' ,quoted: message.data})
