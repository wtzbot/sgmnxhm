...
if (Config.WORKTYPE == 'private') {
    ...
    Trex.addrex({pattern: 'aps', fromMe: true,  deleteCommand: true }, (async (message, match) => {
...
╰──────────────`,quoted: message.data})
    ...
    Trex.addrex({pattern: 'ps2017', fromMe: true,  deleteCommand: true }, (async (message, match) => {
...
╰──────────────`,quoted: message.data})
  ...
  Trex.addrex({pattern: 'ps2018', fromMe: true,  deleteCommand: true }, (async (message, match) => {
...
╰──────────────`,quoted: message.data})
  ...
  Trex.addrex({pattern: 'ps2020', fromMe: true,  deleteCommand: true }, (async (message, match) => {
...
╰──────────────`,quoted: message.data})
    ...
    Trex.addrex({pattern: 'ps2021', fromMe: true,  deleteCommand: true }, (async (message, match) => {
...
╰──────────────`,quoted: message.data})
  ...
  Trex.addrex({pattern: 'ps2022', fromMe: true,  deleteCommand: true }, (async (message, match) => {
